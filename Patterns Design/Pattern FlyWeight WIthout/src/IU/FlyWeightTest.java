...
public class FlyWeightTest extends JFrame {
	...
	private ArrayList<MyRect> lst = new ArrayList();
	...
	Color[] shapeColor = {Color.MAGENTA, Color.CYAN, Color.WHITE, Color.BLUE};
	...
	public FlyWeightTest(){
		...
		lblText = new JLabel("Without FlyWeight Pattern");
		...
		startDrawing.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent event){
				...
				for(int i = 0; i < 1000000; ++i){
					...
					lst.add(new MyRect(getRandColor(), getRandX(), getRandY(), getRandX(), getRandY()));
					lst.get(i).draw(g);
					
					System.out.println("Creando rectangulo nuevo " + i);
